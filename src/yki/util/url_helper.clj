...
(defmethod ig/init-key :yki.util/url-helper [_ {:keys [virkailija-host yki-host liiteri-host protocol-base] :or
                                                {virkailija-host "" yki-host "" liiteri-host "" protocol-base "https"}}]
